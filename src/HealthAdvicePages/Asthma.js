...
export const Asthma = () => {
  ...
  return (
    <div className='asthmapicturebackground'>

      <div className='cover'>
        <div className='PollenContainer'>
          <h1 style={{position:'absolute', left:'40%'}}>Asthma</h1>
...
<h2>How to best prevent symptoms of Asthma?</h2>
<p>
