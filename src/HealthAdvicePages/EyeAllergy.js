...
export const EyeAllergy = () => {

  return (
    <div className='eyeallergypicturebackground'>

      <div className='cover'>
        <div className='PollenContainer'>
          <h1 style={{position:'absolute', left:'40%'}}>Eye Allergies</h1>
     
        <div className='Pollendescription'>
       <h2> What are Eye Allergies?</h2>
...
<h2>How to best prevent symptoms of Eye Allergies?</h2>
<p>
...
<h2>Different types of symptoms and what to do?</h2>
<p>
...
<h2>Treatments for Eye Allergies</h2>
<p>
