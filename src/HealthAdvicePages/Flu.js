...
export const Flu = () => {
  ...
  return (
    <div className='Flupicturebackground'>

      <div className='cover'>
        <div className='PollenContainer'>
          <h1 style={{position:'absolute', left:'40%'}}>The Flu</h1>
...
<h2>How to best prevent symptoms of The Flu?</h2>
<p>
