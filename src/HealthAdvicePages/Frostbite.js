...
export const FrostBite = () => {
  ...
  return (
    <div className='FrostBitepicturebackground'>

      <div className='cover'>
        <div className='PollenContainer'>
          <h1 style={{position:'absolute', left:'40%'}}>Frost Bite</h1>
     
        <div className='Pollendescription'>
       <h2> What is Frost Bite?</h2>
...
<h2>How to best prevent symptoms of Frost Bite?</h2>
<p>
...
<h2>Treatments for Frost Bite</h2>
<p>
