...
export const HeatCramps = () => {

  return (
    <div className='HeatCrampspicturebackground'>

      <div className='cover'>
     
        <div className='PollenContainer'>
          <h1 style={{position:'absolute', left:'40%'}}>Heat Cramps</h1>
     
        <div className='Pollendescription'>
       <h2> What are Heat Cramps?</h2>
...
<h2>How to best prevent symptoms of Heat Cramps?</h2>
<p>
...
<h2>Treatments for Heat Cramps</h2>
<p>
